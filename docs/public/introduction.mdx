...
- 📊 **Semantic Search** - ChromaDB vector search plus structured SQLite filtering
...
4. **SQLite Database** - Stores sessions, observations, summaries; mirrored to ChromaDB for semantic search
